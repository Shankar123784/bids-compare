		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#combidsappsbids-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combidsappsbids-display": {
								"semanticObject": "combidsappsbids",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bids.appsbids",
									"url": sap.ui.require.toUrl("com/bids/appsbids")
								}
							}
						}
					}
